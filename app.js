const localData = {
  news: [
    { date: '2025–2026', category: 'BENDRUOMENĖ', title: 'Sveikiname visus su 2025–2026 mokslo metais!', text: 'Daugiau informacijos apie mokyklos mokslo metus ir tvarkaraštį.', link: 'pages/tvarkarastis.html', image: 'assets/su naujais.png' },
...
const englishData = {
  news: [
    { date: '2025–2026', category: 'COMMUNITY', title: 'Welcome to the 2025–2026 school year!', text: 'More information about the school year and timetable.', link: 'pages/tvarkarastis.html', image: 'assets/su naujais.png' },
...
const translations = {
  en: {
    ...
    '#news .eyebrow': 'WHAT’S HAPPENING', '#news h2': 'News and events', '#news .section-head .text-link': 'All news <span>→</span>', '.news-archive-cta p': 'Find all previous news and photographs in our news archive.', '.news-archive-cta .btn': 'Open news <span>→</span>', '.latest-card .eyebrow': 'LATEST NEWS · 2025–2026', '.latest-card .btn': 'Read more <span>→</span>',
